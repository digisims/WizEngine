#ifndef WIZSCENEMANAGERQUADTREE_H
#define WIZSCENEMANAGERQUADTREE_H
...
class wizSceneManagerQuadTree : public wizSceneManagerBVH
{
    public:

    wizSceneManagerQuadTree();
    virtual ~wizSceneManagerQuadTree();
...
#endif // WIZSCENEMANAGERQUADTREE_H
