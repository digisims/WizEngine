...
wizLines::wizLines(unsigned int _cache)
{
...
void wizLines::applyGlobalSettings()
{
...
void wizLines::undoGlobalSettings()
{
...
void wizLines::rotate(unsigned int _start, unsigned int _stop, float _x, float _y, float _angle)
{
...
void wizLines::drawNGon(wizVector2 _position, wizVector2 _size, wizColour _colour, unsigned int _detail, float _angle)
{
    float angle = 0;
...
void wizLines::drawRectangle(wizVector2 _position, wizVector2 _size, wizColour _colour, float _angle)
{
...
void wizLines::drawTriangle(wizVector2 _v1, wizVector2 _v2, wizVector2 _v3, wizColour _colour, float _angle)
{
...
void wizLines::drawPolygon(wizVector2* _v, unsigned int _vertices, wizColour _colour, float _angle)
{
...
void wizLines::batchNGon(wizVector2 _position, wizVector2 _size, wizColour _colour, unsigned int _detail, float _angle)
{
    if (locked) return;
...
void wizLines::batchRectangle(wizVector2 _position, wizVector2 _size, wizColour _colour, float _angle)
{
    if (locked) return;
...
void wizLines::batchTriangle(wizVector2 _v1, wizVector2 _v2, wizVector2 _v3, wizColour _colour, float _angle)
{
    unsigned int start = vertices;
...
void wizLines::batchPolygon(wizVector2* _v, unsigned int _vertices, wizColour _colour, float _angle)
{
    unsigned int start = vertices;
...
void wizLines::enableBlending(unsigned int _src, unsigned int _dst)
{
    glEnable(GL_BLEND);
    glBlendFunc(_src, _dst);
}

void wizLines::disableBlending()
{
    glDisable(GL_BLEND);
}
