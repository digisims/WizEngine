#include "wizFadeToEffect.h"

wizFadeToEffect::wizFadeToEffect(float _maxTime, bool _allowInterrupt, wizPrimitives* _primitive, wizColour _src, wizColour _dst) : wizFadeEffect(_maxTime, _allowInterrupt)
{
    src = _src;
    dst = _dst;
...
wizFadeToEffect::~wizFadeToEffect()
{
}

void wizFadeToEffect::render()
{
    float r = getRatio();
